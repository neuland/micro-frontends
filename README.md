...
## Author
**Michael Geers** ([@naltatis](https://twitter.com/naltatis)) is a software engineer at [neuland Büro für Informatik](https://www.neuland-bfi.de/) and works on building nice frontends for e-commerce.<br>
This site is generated by Github Pages. The source can be found at [neuland/micro-frontends](https://github.com/neuland/micro-frontends/).